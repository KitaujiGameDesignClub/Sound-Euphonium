...
namespace IngameDebugConsole
{
	...
	public class DebugLogManager : MonoBehaviour
	{
		...
		private static bool _ShowDebugLogManager;
		
		/// <summary>
		/// 调试窗是否被开启
		/// </summary>
		public static bool ShowDebugLogManager
		{
			get
			{
				return _ShowDebugLogManager;
			}
		}
